...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-%d$d(=tg6tengouqane%hj*_fr8r-w^g7vf@z_cmxmr!v9&)#a')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["localhost", "vdv-pkpass.eu.ngrok.io", "127.0.0.1", "direct-qrcamera.preview.emergentagent.com", "*.preview.emergentagent.com", "42e4a65b-cb35-4fec-aadc-3df0e0a9c12c.preview.emergentagent.com", "race-scanner.preview.emergentagent.com"]
...
CSRF_TRUSTED_ORIGINS = ["http://localhost", "https://vdv-pkpass.eu.ngrok.io", "https://race-scanner.preview.emergentagent.com", "https://race-scanner.preview.emergentagent.com", "https://race-scanner.preview.emergentagent.com"]
